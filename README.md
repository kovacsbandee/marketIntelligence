...
## updater to have the latest dataset, for each run of the analysis
## real time decisions on out of the box analytics systems
...
3. Create plotly graphs in a notebook for the analysis of all the downloaded data, or a dash EDA tool.
    ideas:
        ...
        - create aggregate views for the company charts
4. Find patterns for trend reversals aiming for at least 20% change in a few month and download the news in their vicinity.
          -> iterate 4, 3, 2 and if necessary 1 in this order if the first attempt was not successful
5. If 4 was successful do the above for 5 more stocks.
deadline January the 19th!

6. If 5 was successful phrase it as an algorithm and test it on 5 other stocks!
